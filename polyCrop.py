...
def polyCrop(image, rect_box, poly_box):
    ...
    cv2.polylines(display_img, [point_polylines], True, (200, 0, 100))
    ...
    return display_img, masked_image
...
def ratioImputation(img, target_ration=(60, 180)):
    ...
    # base on height
    target_width = int(height / target_ration[0] * target_ration[1])

    # base on weight
    target_height = int(width / target_ration[1] * target_ration[0])
...
if __name__ == "__main__":
    ...
    point_polylines = [[230, 150], [420, 140], [460, 300], [240, 310]]
    ...
    display_img, masked_image = polyCrop(image, rect_box=point_rect, poly_box=point_polylines)
